        ...
        <span className="flex">
          {navigation.social.map((item) => (
            <motion.a
              ...
              className="dark:hover:text-gray-50 dark:focus:text-gray-50 mx-1 p-2 dark:text-cyan-200 focus:text-cyan-400 hover:text-cyan-400 text-gray-700 text-xl rounded-md sm:mx-2 sm:text-3xl"
