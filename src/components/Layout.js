...
export default function Layout({ children, confetti = false, slug = 'index' }) {
  ...
  return (
    <div className="pt-2 w-full min-h-screen bg-gradient-to-r dark:from-yellow-300 from-yellow-400 dark:to-cyan-400 to-cyan-500 dark:via-pink-400 via-pink-500 overflow-hidden">
