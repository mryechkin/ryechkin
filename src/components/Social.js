    ...
    <span className={cn('flex', className)}>
      {social.map((item) => (
        <motion.a
          ...
          className="p-2 mx-1 text-xl text-gray-700 hover:text-sky-300 focus:text-sky-300 dark:text-gray-200 dark:hover:text-sky-300 dark:focus:text-sky-300 sm:mx-2 sm:text-3xl"
