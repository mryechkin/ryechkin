...
export default function HeroContainer({ className, children, title }) {
  return (
    <div className="flex flex-col items-center justify-center border-2 border-indigo-300 rounded-md bg-gray-50 shadow-retro dark:border-indigo-500 dark:bg-gray-800 dark:shadow-retro-dark">
      {title && (
