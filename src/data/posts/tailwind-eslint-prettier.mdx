---
title: 'Streamlining your Tailwind workflow with ESLint + Prettier'
date: '2022-07-13'
published: true
...
<PostImage
  ...
  caption="Let ESLint and Prettier work their magic ✨"
  width={1262}
  height={417}
/>
...
<PostImage
  ...
  title="Example output of our linting script"
  width={2154}
  height={536}
/>
...
> <center>[eslint-config-acme](https://www.npmjs.com/package/eslint-config-acme)</center>
