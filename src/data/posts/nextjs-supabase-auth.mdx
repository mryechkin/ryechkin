...
<blockquote className="!border-l-red-500">
  **IMPORTANT NOTE:** This article was written for Supabase **v1**, which is now outdated.
  Though everything still works (to the best of my knowledge), please be aware that the
  libraries and versions mentioned here **are now outdated**. See the ✨NEW✨ [updated
