...
> **IMPORTANT NOTE:** This article was written for **v1** of Supabase, and is now outdated. Though everything still works fine, just be aware that this is using the older version. An updated guide is coming soon!
