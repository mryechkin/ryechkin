...
<Warning>
  Please note that this guide is **not** using the latest version of **Next.js Auth
  Helpers** (`0.7.x` at the time of writing), as it introduced some breaking changes and
  regressions in Reset Password flow. The version used in this guide is pinned at `0.6.1`.
  If you'd like to use the latest version, please see the [v0.7.x migration
  guide](https://supabase.com/docs/guides/auth/auth-helpers/nextjs#migrating-to-v07x).
</Warning>
...
**EDIT:** Both [React](https://react.dev) and [Next.js](https://nextjs.org) docs have since been released.
