...
- [Discussion on replacing SASS](https://github.com/Shopify/foundational-design-system-proto/discussions/44) in Shopify's [Foundational Design System](https://github.com/Shopify/foundational-design-system-proto) (successor to [Polaris](https://polaris.shopify.com/)) 👈 great summary and comparison of the current CSS tech (**MUST READ**)
